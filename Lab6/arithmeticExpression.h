...
class arithmeticExpression{
  ...
  public:
    ...
    //void visualizeTree(const string &); //commented out because not needed for lab
 ...
 private:
    ...
    //void visualizeTree(ofstream &, TreeNode *); //commented out because not needed for lab

    //helper function for destructor
    void recurDelete(TreeNode *);
