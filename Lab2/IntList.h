...
class IntList {
    private:
        IntNode* dummyHead;
        IntNode* dummyTail;
        //putting copy constructor and copy assignment oeprator here (rule of 3), but not implementing them
    ...
    public:
        ...
        //Does NOT send to the stream a newline or space at the end.
